...
const AdminProducts = () => {
  ...
  const updateProduct = useMutation({
    mutationFn: async (updatedProduct: Partial<Product> & { _id: string }) => {
      ...
      const res = await axios.put(
        `${import.meta.env.VITE_API_URL}/api/product/${_id}`,
        data
      );
      return res.data;
    },
  ...
  if (!data || data.length === 0)
    return (
      <Heading className="text-center py-10">No products available</Heading>
    );
  ...
  return (
    <div className="px-6 lg:px-4 w-full 2xl:w-[1600px] 2xl:mx-auto">
      <Flex justify="between" align="center" className="gap-4 sm:gap-0">
        <h2 className="text-lg sm:text-xl md:text-2xl font-medium py-6">
          Products
        </h2>
            ...
            >
              ...
              <div className="hidden xl:grid xl:grid-cols-[100px_230px_140px_150px_150px_120px] 2xl:grid-cols-[150px_300px_200px_180px_150px_150px] p-3 text-sm text-center gap-2 items-center">
                <img
                  src={product.image}
                  alt={product.name}
                  className="w-12 h-12 object-contain rounded-md mx-auto"
                />
              ...
              <div className="p-4 md:hidden">
                <div className="flex flex-col items-center text-center">
                  <img
                    src={product.image}
                    alt={product.name}
                    className="w-12 h-12 object-contain rounded-md mb-3"
                  />
