...
const UserDashboard = () => {
  ...
  if (isLoading)
    return (
      <Text as="p" className="text-xl text-center mt-10">
        Loading...
      </Text>
    );
  if (isError)
  ...
  if (!data || data.length === 0)
    return (
      <Text as="p" className="text-xl mt-10 text-center">
  ...
  return (
    <div className="sm:px-4 2xl:w-[1600px] mx-auto">
      <h2 className="text-xl md:text-2xl text-center lg:text-left py-5 font-medium">
        Dashboard
      </h2>
      ...
      <div className="flex flex-col xl:flex-row md:gap-4">
        ...
        <Box className="py-4 sm:py-0 mb-4 xl:pb-0 xl:w-2/3">
          <div className="space-y-8 p-4 shadow-md rounded-lg bg-white">
            <Text
              as="p"
              className="pb-4 text-center lg:text-left text-lg font-medium"
            >
              Appointment
            </Text>
                ...
                return (
                  ...
                  >
                    <Text
                      ...
                      color="indigo"
                      size="2"
                      className="flex items-center justify-center xl:justify-center"
                    >
